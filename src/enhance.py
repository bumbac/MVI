...
parser.add_argument("--model_path", type=str, default='/content/drive/MyDrive/COLAB/cm/src/best_ckpt/ckpt',
                    help="the path where the model is saved")
parser.add_argument("--test_dir", type=str, default='/content/drive/MyDrive/COLAB/cm/data/in/test/noisy',
                    help="noisy tracks dir to be enhanced")
parser.add_argument("--save_tracks", type=str, default=True, help="save predicted tracks or not")
parser.add_argument("--save_dir", type=str, default='/content/drive/MyDrive/COLAB/cm/data/out', help="where enhanced tracks to be saved")
